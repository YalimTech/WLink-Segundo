...
-- CreateIndex
CREATE UNIQUE INDEX "instances_instanceId_key" ON "instances"("instanceId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "instances_instanceName_key" ON "instances"("instanceName" ASC);

-- CreateIndex
CREATE INDEX "instances_locationId_idx" ON "instances"("locationId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "users_locationId_key" ON "users"("locationId" ASC);
